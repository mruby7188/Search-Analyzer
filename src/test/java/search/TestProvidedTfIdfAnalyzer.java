...
//        ISet<Webpage> gutenberg = new ChainedHashSet<Webpage>();
//        for ()
        long start = System.currentTimeMillis();
                TfIdfAnalyzer analyzer = this.makeExampleAnalyzer();

//        TfIdfAnalyzer analyzer = new TfIdfAnalyzer(new Webpage("www.gutenberg.org"));
        System.out.println(System.currentTimeMillis() - start + " mls");
    }
    
    @Test(timeout=SECOND)
    public void testQueryNotInDocs() {
        TfIdfAnalyzer analyzer = this.makeExampleAnalyzer();

        IList<String> query = new DoubleLinkedList<>();
        query.add(" ");
        query.add("fdfjkdsanenkfdsa");
